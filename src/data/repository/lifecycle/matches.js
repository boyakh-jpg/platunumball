...
export function getMatchRecordComposition(draft = {}) {
  return draft.recordComposition === "team" ? "team" : "individual";
}
export function getMatchRecordDraftInvalidReason(state, draft = {}, mode = "") {
...
export function getTrustedRefereeId(state, refereeId, playerIds = []) {
...
export function generateTournamentMatches(state, tournament, options = {}) {
...
export function getStateRepresentativeTeamId(state, userId) {
...
export function getLocalTournamentTeamSnapshot(state, team, options = {}) {
...
export function advanceTournamentAfterMatch(state, confirmedMatch) {
...
export function finalizeMatch(state, targetMatch) {
