...
const loadDirectory = app.actions.loadDirectory;
  ...
  const {
    ...
    courtFieldLocation, courtFieldLocationPending, courtQuotaBlocked, naverMapKeyReady, courtAddressSelected, courtDisplayName,
  ...
  return {
    ...
    courtDraft, courtPhotos, courtPhotoPending, courtFieldLocation, courtFieldLocationPending, courtQuotaBlocked,
    refereeDraft,
