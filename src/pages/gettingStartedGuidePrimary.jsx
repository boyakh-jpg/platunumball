...
export const GUIDE_CHAPTERS = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "심판·방장·모바일 전광판 담당자·선수의 권한은 분리됩니다. 열린 이의를 처리하고 별도 최종 승인을 마친 확정 경기만 공식 전적이 됩니다.",
        Icon: Trophy,
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "경기 전 QR 출석",
        body: "경기 20분 전부터 모바일 전광판의 QR을 로그인한 사전 등록 선수가 스캔합니다. 출전·후보 선수가 모두 출석하면 예정시간 전에도 시작할 수 있고, QR은 해당 경기의 체크인 시간에만 유효합니다.",
        Icon: QrCode,
      },
      {
        title: "미출석과 지각 QR",
    ...
    callout: {
      title: "출석 상태는 자동으로 갱신됩니다",
      body: "출석판과 QR 상태는 자동으로 갱신되며 필요하면 직접 새로고침할 수 있습니다.",
      details: [
  ...
  },
  {
    ...
    navLabel: "진행",
    eyebrow: "04 · 경기 진행",
    title: "심판·모바일 전광판 담당자·선수가 역할을 나눕니다.",
    lead: "심판 유무와 모바일 전광판 사용 여부에 따라 점수·기록·최종 승인 권한이 분리됩니다.",
    image: "/assets/guide/live-clock.jpg?v=20260728-guide-r3",
    imageAlt: "A/B 점수판과 30초 샷클락이 함께 열린 가로형 BOXTIER 모바일 전광판",
    ...
    steps: [
      ...
      {
        title: "모바일 전광판",
        body: "출전 선수·후보·심판 중 지정된 담당자가 경기시계·점수 입력판·샷클락·출석 QR을 맡습니다. 양쪽 점수는 심판 경기에서는 배정 심판, 무심판 경기에서는 전광판 담당자가 조작합니다. 담당 기기에 연결된 워치·비오디오 미디어 리모컨으로도 샷클락을 초기화할 수 있습니다.",
        Icon: Gauge,
      },
    ],
    callout: {
      title: "정상 사용 여부를 확인합니다",
      ...
      details: [
        ...
        "휴대폰·태블릿의 블루투스 설정에서 워치 또는 비오디오 미디어 리모컨을 먼저 연결합니다. 현재 모바일 전광판 담당자가 라이브 화면을 한 번 터치한 뒤 리모컨의 재생 또는 일시정지를 누르면 설정한 샷클락 시간으로 초기화됩니다.",
  ...
  },
  {
    ...
    steps: [
      {
        title: "현장 일반 경기",
        body: "심판 경기는 심판이 점수·개인 스탯·이의·최종 승인을 맡습니다. 공격권을 상대에게 넘긴 원인이 된 선수에게 턴오버(TO)를 기록합니다. 패스 실수, 볼을 빼앗김, 트래블링·더블 드리블 등이 해당합니다. 무심판 경기는 팀 점수만 저장하고 방장이 이의와 최종 승인을 맡습니다.",
        Icon: ClipboardCheck,
      },
      {
        title: "사후 경기기록",
    ...
    callout: {
      ...
      details: [
        "사후 경기 기록은 확인 기간 안에 참가를 확인한 선수만 개인 MMR 반영 대상이 되며 팀 MMR은 반영하지 않습니다. 내 기록은 MMR에 반영되지 않습니다.",
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "개인·팀 MMR",
        body: "개인은 통합과 1v1·2v2·3v3·5v5 MMR을 나눠 봅니다. 팀 MMR은 확정 경기의 실제 참여 명단으로 계산합니다.",
        Icon: Gauge,
      },
    ],
    callout: {
      title: "경기시계 사용만으로 MMR 반영이 확정되지는 않습니다",
      body: "정상 사용은 경기 검증 조건 중 하나입니다.",
      details: [
  ...
  },
  {
    ...
    lead: "팀장은 팀 자체를 관리하고, 실제 경기에서는 방장과 주장이 방의 명단과 진행 역할을 맡습니다.",
    ...
    steps: [
      ...
      {
        title: "팀전 만들기",
        body: "팀전은 팀장만 만드는 기능이 아닙니다. 일반 팀원도 소속팀을 선택해 방을 만들 수 있고, 경기에서는 각 주장이 출전·후보 명단을 운영합니다.",
        Icon: Swords,
      },
      {
        title: "팀 찾기",
    ...
    callout: {
      ...
      details: [
        ...
        "팀 MMR은 실제 참여 명단을 기준으로 반영합니다.",
        "용병 참가가 포함된 경기는 팀 MMR 반영 기준이 달라질 수 있습니다.",
      ],
      Icon: ShieldCheck,
    },
    actions: [
