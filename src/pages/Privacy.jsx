  ...
  return (
    ...
    >
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>모집방·초대·참가·채팅, 경기 일정·출석·결과·개인 기록, 팀·대회, MMR·랭킹·신뢰도, 심판 활동·시험, 즐겨찾기·알림</td>
                <td>경기 운영, 기록과 랭킹 계산, 분쟁 처리, 맞춤 목록 제공</td>
              ...
              <tr>
                <th scope="row">구장</th>
                <td>신청자 식별자, 핀 좌표, 주소, 시설명·운영 정보·연락처·URL, 리뷰와 신고 내용</td>
                <td>구장 등록·중복 확인·검수·검색·리뷰 제공</td>
      ...
      <section id="privacy-public">
        ...
        <p><Link to="/app/settings">설정</Link>에서 지역 랭킹, 팀 이력, 통계 요약의 공개 여부를 변경할 수 있습니다. 비공개 설정 전 이미 다른 이용자가 별도로 저장한 정보까지 회수되지는 않습니다.</p>
      </section>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>이미지 저장·전송과 네트워크 보호. 업로드 이미지·요청 정보</td>
