  ...
  return (
    ...
    >
      ...
      <section id="privacy-rights">
        ...
        <p>이용자와 법정대리인은 본인 또는 보호 대상 아동의 개인정보에 대해 열람, 정정, 삭제, 처리정지, 동의 철회와 회원 탈퇴를 요구할 수 있습니다. 프로필·공개 설정·Discord 연결과 회원 탈퇴는 서비스 설정에서 직접 처리할 수 있고, 그 밖의 요청은 아래 개인정보 문의처로 접수할 수 있습니다.</p>
