...
return (
    <div className="page-stack match-room">
      ...
      <Card className="gm-next-action-card">
        ...
        ) : nextAction.type === "record-participation" ? (
          <Button type="button" disabled={Boolean(managementActionPending)} onClick={() => void confirmCurrentUserParticipation()}>{nextAction.button}</Button>
        ) : nextAction.href ? (
