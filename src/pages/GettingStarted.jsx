...
const GUIDE_CHAPTERS = [
  {
    ...
    steps: [
      ...
      {
        title: "역할에 따라 진행합니다",
        body: "심판은 개인 스탯과 최종 확정을 맡습니다. 경기시계 담당자는 양쪽 점수와 시계·샷클락·QR을 맡습니다.",
        Icon: ClipboardCheck,
      },
      {
  ...
  },
  {
    ...
    lead: "심판 유무에 따라 시작·종료·확정 권한이 달라지고, 경기시계 담당자는 양쪽 점수와 시계를 맡습니다.",
    ...
    steps: [
      ...
      {
        title: "심판이 없는 경기",
        body: "방장이 출석·시작·종료·최종 확정을 맡고, 지정된 경기시계 담당자가 양쪽 점수와 시계·샷클락·QR을 맡습니다.",
        Icon: UserRoundCheck,
      },
      {
        title: "후보 교체",
      ...
      {
        title: "경기시계",
        body: "출전 선수·후보·심판 중 지정된 담당자만 양쪽 점수와 경기시계·샷클락을 조작하고 출석 QR을 표시합니다.",
        Icon: Gauge,
      },
    ],
    callout: {
  ...
  },
  {
    ...
    callout: {
      ...
      details: [
        ...
        "사후 경기 기록은 참가자 전원이 최종 승인하며, 열린 이의가 없으면 방의 10·15·20분 이의시간 종료 뒤 자동 확정됩니다.",
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "심판·경기시계 화면",
        body: "심판의 개인 기록 권한과 경기시계 담당자의 점수·시계·샷클락·QR 권한을 역할 화면에서 확인합니다.",
        Icon: Clock3,
      },
      {
        title: "기록 입력과 확정",
    ...
    callout: {
      ...
      details: [
        ...
        "점수판은 지정된 경기시계 담당자 화면에서만 조작할 수 있습니다.",
      ],
      Icon: ShieldCheck,
    },
    actions: [
