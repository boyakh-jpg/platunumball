...
export const RECRUITING_ROOM_DEPENDENCIES = {
  ...
  getRecruitingFit, getPlayerMatchModeMmr, getRecruitingLobby, getRecruitingRoomOwnerId, getRecruitingPostTerminalState, getRecruitingSideCapacity, getRecruitingTargetMmr,
