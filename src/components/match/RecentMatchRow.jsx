...
export default function RecentMatchRow({
  ...
  const rootClassName = ["recent-match-row", "ui-design-info-surface", "ui-design-info-accent", "ui-design-record-surface", `result-${resultToken}`, className].filter(Boolean).join(" ");
  const content = (
    <>
