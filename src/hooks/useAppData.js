...
export function useAppData(authUser = null, appLocation = null) {
  ...
  const actions = useMemo(
    () => {
      ...
      setMatchDualScoreRecorderSide: (matchId, side) => applyMatchMutation(matchId, (prev) => setMatchDualScoreRecorderSide({ ...prev, currentUserId }, matchId, side), { action: "setMatchDualScoreRecorderSide", side }),
      ...
      requestMatchRecorderTakeover: (matchId, side) => applyMatchMutation(matchId, (prev) => requestMatchRecorderTakeover({ ...prev, currentUserId }, matchId, side), { action: "requestMatchRecorderTakeover", side }),
      approveMatchRecorderTakeover: (matchId, side, requestId) => applyMatchMutation(matchId, (prev) => resolveMatchRecorderTakeover({ ...prev, currentUserId }, matchId, side, requestId, "approved"), { action: "approveMatchRecorderTakeover", side, requestId }),
      rejectMatchRecorderTakeover: (matchId, side, requestId) => applyMatchMutation(matchId, (prev) => resolveMatchRecorderTakeover({ ...prev, currentUserId }, matchId, side, requestId, "rejected"), { action: "rejectMatchRecorderTakeover", side, requestId }),
      cancelMatchRecorderTakeover: (matchId, side, requestId) => applyMatchMutation(matchId, (prev) => resolveMatchRecorderTakeover({ ...prev, currentUserId }, matchId, side, requestId, "cancelled"), { action: "cancelMatchRecorderTakeover", side, requestId }),
      ...
      handoffMatchRecorder: (matchId, sideName, nextRecorderId) => {
        return applyMatchMutation(matchId, (prev) => handoffMatchRecorder({ ...prev, currentUserId }, matchId, sideName, nextRecorderId), { action: "handoffMatchRecorder", sideName, nextRecorderId });
      },
