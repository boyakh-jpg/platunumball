...
const BASE_QUESTIONS = [
  ...
  {
    category: "rankball",
    stem: "후보 선수가 경기 밖에서 기록자로 활동할 때 가장 중요한 원칙은?",
    choices: ["본인이 본 사실만 신속하게 기록한다", "자기 팀 점수만 임의로 올린다", "상대 파울은 무조건 기록한다", "기록을 경기 후 하루 뒤에 몰아서 한다"],
    answerIndex: 0,
    explanation: "후보 기록자는 관찰한 사실만 기록해야 한다.",
  },
  {
    category: "rankball",
  ...
  },
  {
    ...
    choices: ["선수와 기록자가 같은 판정을 이해하게 하기 위해", "경기를 지연하기 위해", "공격권을 숨기기 위해", "팀을 응원하기 위해"],
    answerIndex: 0,
  ...
  {
    category: "ethics",
    stem: "기록자가 보지 못한 스탯을 선수 요청만으로 입력해 달라고 한다. 적절한 답은?",
