...
export const MAX_TEAM_DESCRIPTION_LENGTH = 300;
export const MAX_TEAM_DESCRIPTION_LINES = 5;
...
// Operational courts are loaded from approved_courts. Deleted synthetic c1..c12
// must not be recreated by a browser fallback.
