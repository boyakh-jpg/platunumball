...
export function mapRemoteTeamEmblem(row = {}) {
  const emblemKey = row.emblem_key ?? null;
  return {
    emblemKey,
    emblemSource: row.emblem_source ?? (emblemKey ? "upload" : "initial"),
...
export function mapClientTeamEmblem(team = {}) {
  const emblemKey = team.emblemKey ?? null;
  return {
    emblemKey,
    emblemSource: team.emblemSource ?? (emblemKey ? "upload" : "initial"),
...
export function getTeamEmblemErrorMessage(code = "") {
  const messages = {
    ...
    team_emblem_too_large_after_resize: "이미지를 처리하지 못했습니다. 다른 사진으로 다시 시도해 주세요.",
    team_emblem_permission_denied: "팀 주장만 엠블럼을 변경할 수 있습니다.",
    team_emblem_conflict: "다른 변경이 먼저 저장되었습니다. 최신 상태를 확인한 뒤 다시 시도해 주세요.",
    team_emblem_upload_unavailable: "먼저 사용할 사진을 저장해 주세요.",
    team_emblem_restore_unavailable: "되돌릴 이전 사진이 없습니다.",
    team_emblem_restore_failed: "이전 사진으로 되돌리지 못했습니다.",
    profile_emblem_upload_unavailable: "먼저 사용할 사진을 저장해 주세요.",
    profile_emblem_image_disabled: "개인 사진 엠블럼은 사용하지 않습니다.",
    team_emblem_cooldown: "교체 제한 기간입니다. 표시된 날짜 이후 다시 시도해 주세요.",
    team_emblem_moderation_blocked: "운영 조치로 사진 업로드가 제한되었습니다. 표시된 날짜 이후 다시 시도해 주세요.",
    team_emblem_not_reportable: "현재 표시 중인 팀 사진만 신고할 수 있습니다.",
    team_emblem_report_unavailable: "신고할 수 있는 팀 사진이 없습니다.",
    team_emblem_report_stale: "신고 뒤 팀 사진이 변경되었습니다. 현재 사진을 다시 확인해 주세요.",
    cannot_report_own_team_emblem: "내가 주장인 팀 엠블럼은 직접 신고할 수 없습니다.",
    profile_icon_unavailable: "아직 사용할 수 없는 아이콘입니다.",
    profile_emblem_cooldown: "교체 제한 기간입니다. 표시된 날짜 이후 다시 시도해 주세요.",
    discord_avatar_unavailable: "Discord 연동 이미지가 없습니다.",
    invalid_emblem_color: "엠블럼 색상을 확인해 주세요.",
    invalid_team_emblem_text_mode: "팀명 또는 약칭을 선택해 주세요.",
    invalid_team_emblem_abbreviation: "약칭은 공백을 제외한 1~4자로 입력해 주세요.",
    invalid_team_emblem_font: "글꼴을 다시 선택해 주세요.",
    cloudflare_r2_not_configured: "현재 사진 저장 기능을 사용할 수 없습니다. 잠시 후 다시 시도해 주세요.",
    cloudflare_r2_upload_failed: "사진을 업로드하지 못했습니다. 잠시 후 다시 시도해 주세요.",
    cloudflare_r2_delete_failed: "이전 사진을 정리하지 못했습니다. 잠시 후 다시 시도해 주세요.",
  };
