export const BASE_QUESTIONS = [
  ...
  {
    category: "rankball",
    stem: "후보 선수가 모바일 전광판 담당자로 지정됐을 때 가능한 조작은?",
    choices: ["시간과 샷클락을 서버 상태와 맞춰 조작한다", "심판 경기의 점수를 임의로 올린다", "개인 스탯을 입력한다", "최종 승인을 대신한다"],
    answerIndex: 0,
    explanation: "심판 경기의 모바일 전광판 담당자는 경기시계와 샷클락만 조작한다.",
  },
  {
    category: "rankball",
    stem: "BOXTIER 심판 경기에서 개인 기록을 입력할 수 있는 사람은?",
    choices: ["배정 심판만", "모바일 전광판 담당자", "방장", "모든 출전 선수"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["개인 기록을 생성하지 않는다", "방장이 전원 기록한다", "각자 기록한다", "모바일 전광판 담당자가 기록한다"],
    answerIndex: 0,
