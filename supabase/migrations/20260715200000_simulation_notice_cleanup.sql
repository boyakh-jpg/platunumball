...
begin
  ...
  where delivery.notification_id like 'sim_notice\_%' escape '\'
     or delivery.payload->>'notificationId' like 'sim_notice\_%' escape '\';
...
revoke all on function public.rankball_cleanup_simulation_notices() from public;
grant execute on function public.rankball_cleanup_simulation_notices() to service_role;

grant delete on table public.room_feed_cards to service_role;
