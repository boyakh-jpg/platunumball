...
revoke all on function public.rankball_match_dispute_action_pre_points_bound(text, text, jsonb)
  from public, anon, authenticated, service_role;
revoke all on function public.rankball_cleanup_simulation_artifacts_legacy()
  from public, anon, authenticated, service_role;
  ...
  from (
    values
      (
        ...
        to_regprocedure('public.rankball_match_room_update_action_pre_change_deadline(text,text,jsonb)')
      ),
      (
        ...
        to_regprocedure('public.rankball_recruiting_room_update_action_pre_change_deadline(text,text,jsonb)')
      ),
      (
        'rankball_match_dispute_action_pre_points_bound',
        'public.rankball_match_dispute_action_pre_points_bound(text,text,jsonb)',
        to_regprocedure('public.rankball_match_dispute_action_pre_points_bound(text,text,jsonb)')
      ),
      (
        'rankball_cleanup_simulation_artifacts_legacy',
        'public.rankball_cleanup_simulation_artifacts_legacy()',
        to_regprocedure('public.rankball_cleanup_simulation_artifacts_legacy()')
      ),
      (
        ...
        to_regprocedure('public.rankball_match_generate_pickup_assignment_pre_rating_scale_split(text,text,text)')
      )
