...
test("small cross-runtime utilities keep one shared implementation", async () => {
  ...
  const consumers = [
    ...
    ["server/api/matches/sync-match.js", "shared/lib/plainObject.js"],
...
test("server infrastructure helpers preserve route-specific limits and queued delivery rows", async () => {
  ...
  const consumers = [
    ...
    ["server/api/matches/sync-match.js", "lib/discordDeliveryRows.js"],
    ["server/api/recruiting/sync-post.js", "lib/discordDeliveryRows.js"],
    ["server/api/matches/sync-match.js", "lib/tournamentPersistence.js"],
