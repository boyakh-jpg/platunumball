...
6. 한 팀의 등록 인원은 최대 10명이다. 5v5 주전 5명과 교체/후보 5명을 감당하는 운영 단위로 본다.
7. 팀 가입 초대/가입 승인 플로우가 생기면 팀 정원 10명 도달 시 같은 서버 transaction에서 남은 pending 팀 가입 초대를 취소/삭제한다. 정원 도달 뒤 새 팀 가입 초대 발송도 막는다.
