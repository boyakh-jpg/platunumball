...
2026-07-01: 방 모달의 포지션 아바타는 티어 엠블럼보다 선수 컷아웃을 살짝 위에 올려 공/상체가 보이게 하고, 닉네임 영역은 마스크로 가리지 않게 둔다.
2026-07-01: 모바일 홈/경기/모집 hero는 카드처럼 둥근 모서리를 주지 않고, viewport 상단/좌우에 붙여 배경이 새지 않게 full-bleed로 둔다.
