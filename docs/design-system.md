...
2026-07-02: 홈 tier rail은 hero 내부가 아니라 오른쪽 보조 rail 맨 위에 둔다. tier rail은 통합 티어 배너와 최근 5경기 승수만 보여주고, 모드별/팀전 티어 카드는 홈에서 제외한다. 친선전/정규전 큐와 승인 대기 경기는 오른쪽 보조 rail이 아니라 왼쪽 메인 라인에 둔다.
