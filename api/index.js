...
import matchReceiptRender from "../server/api/match-receipts/render.js";
...
export const API_ROUTES = new Map([
  ...
  ["/match-receipts/render", route(matchReceiptRender, ["POST"], "internal")],
  ...
  ["/search", route(search, ["POST"], "publicRead")],
